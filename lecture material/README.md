# 🎞️ Lecture Material — Slides, Video Walkthroughs & Audio Explainers

All presentation decks (available as both **PPTX** and **PDF**) for the FDP sessions, along with AI-generated video walkthroughs and an audio explainer for on-the-go listening.

> ▶️ **How to play:** click any **Watch Video** / **Listen to Audio** badge below — it opens the file directly in your browser with full playback controls (GitHub doesn't support inline video players in README files, so this one-click-to-play pattern is the reliable alternative).
> 📄 **PDF vs. PPTX:** use **PDF** for quick viewing directly in the browser (no download needed); use **PPTX** if you want to edit, reuse, or present from the original slides.
...
[![Watch Video](https://img.shields.io/badge/▶️_Watch_Video-MP4-FF0000?style=for-the-badge)](<./Video Explanation/Machine Learning for Environmental & Resource Monitoring.mp4>)
[![Listen to Audio](https://img.shields.io/badge/🎧_Listen-Audio-1DB954?style=for-the-badge)](<./Audio/Machine_learning_and_the_Planetary_Nervous_System.m4a>)

*"Machine Learning and the Planetary Nervous System" — audio explainer covering the full session in listenable form.*
...
[![Watch Video](https://img.shields.io/badge/▶️_Watch_Video-MP4-FF0000?style=for-the-badge)](<./Video Explanation/AI for Environmental Monitoring using Satellite Images CNN vs Vision Transformer.mp4>)
...
[![Watch Video](https://img.shields.io/badge/▶️_Watch_Video-MP4-FF0000?style=for-the-badge)](<./Video Explanation/Deep Learning Applications for Resource Optimization.mp4>)
...
📖 For a full written breakdown of every topic in these decks, see **[`notes/README.md`](../notes/README.md)**.

---
*Video and audio walkthroughs are AI-generated companion explainers for self-paced review after the live sessions.*
